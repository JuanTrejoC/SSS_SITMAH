...
async function main() {
  ...
  const controladoresSemilla = [
    { modelo: 'Econolite ASC/3', cruceroId: crucerosCreados[0].id, semaforos3Luces: 2, semaforos4Luces: 2, totalLedsVerdes: 12, totalLedsRojos: 12, totalLedsAmarillos: 12, pasoPeatonal: true, audible: true, pantallaLed: true, tarjetaRelevadora: true, fuentePoder: true, cpu: true, switch: true, fibraOptica: false, gps: true, botonera: true },
    { modelo: 'Peek Double D', cruceroId: crucerosCreados[1].id, semaforos3Luces: 4, semaforos4Luces: 2, totalLedsVerdes: 18, totalLedsRojos: 18, totalLedsAmarillos: 18, pasoPeatonal: true, audible: false, pantallaLed: false, tarjetaRelevadora: true, fuentePoder: true, cpu: true, switch: false, fibraOptica: false, gps: false, botonera: false },
    { modelo: 'Intelight MaxTime', cruceroId: crucerosCreados[2].id, semaforos3Luces: 4, semaforos4Luces: 4, totalLedsVerdes: 24, totalLedsRojos: 24, totalLedsAmarillos: 24, pasoPeatonal: true, audible: true, pantallaLed: true, tarjetaRelevadora: true, fuentePoder: true, cpu: true, switch: true, fibraOptica: true, gps: true, botonera: true },
    { modelo: 'Semaforos de Mexico S.A.', cruceroId: crucerosCreados[3].id, semaforos3Luces: 3, semaforos4Luces: 0, totalLedsVerdes: 9, totalLedsRojos: 9, totalLedsAmarillos: 9, pasoPeatonal: false, audible: false, pantallaLed: false, tarjetaRelevadora: false, fuentePoder: true, cpu: true, switch: false, fibraOptica: false, gps: false, botonera: false },
    { modelo: 'Siemens M60', cruceroId: crucerosCreados[4].id, semaforos3Luces: 3, semaforos4Luces: 2, totalLedsVerdes: 15, totalLedsRojos: 15, totalLedsAmarillos: 15, pasoPeatonal: true, audible: true, pantallaLed: false, tarjetaRelevadora: true, fuentePoder: true, cpu: true, switch: true, fibraOptica: true, gps: true, botonera: false }
  ];
